...
public class Workshop_tag_fragment extends Fragment {
    ArrayList<Event_model> list_of_event= new ArrayList<>();
    int[] images = {R.drawable.event_placeholder3, R.drawable.event_placeholder2, R.drawable.event_placeholder1,
            R.drawable.event_placeholder5, R.drawable.event_placeholder6};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View viewroot = inflater.inflate(R.layout.tag_workshop, container, false);
        RecyclerView recyclerView = viewroot.findViewById(R.id.Workshop);
        setUpEventList();
